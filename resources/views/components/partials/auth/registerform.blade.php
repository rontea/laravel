 {{--
  ...
  Version: 0
  Date: July, 06, 2023
  File: resources\views\components\partials\auth\registerform.blade.php
 --}}
 ...
 @guest
     ...
     <form class="row g-3 m-2" id="validateForm" action="{{ route('register') }}" method="POST">
         @csrf
         <div class="col-md-4">
         ...
         <div class="col-md-4">
             ...
             <input name="last_name" value="{{ old('last_name') }}" type="text" class="form-control" id="last_name"
                 required>
         ...
         <div class="col-md-4">
             ...
             <input name="email" value="{{ old('email') }}" type="email" class="form-control" id="email_address"
                 placeholder="john@sample.com" required>
